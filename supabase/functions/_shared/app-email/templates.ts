...
export const TEMPLATES: Record<string, EmailTemplate> = {
  ...
  "blood-test-due": t(
    ...
    "transactional",
    false,
    () => "Time to retest your bloods, when it suits you",
    (d) => [
      `Hi ${s(d.name, "there")},`,
      `Your last blood test is starting to age${s(d.due_on) ? ` — you pencilled in ${s(d.due_on)}` : ""}.`,
      "Retesting is optional. Whenever you have new results, you can add them in STRAND and your diet and nutrition guidance will read the new values.",
    ],
