...
// SAFETY-CRITICAL TOPIC. Sourced strictly from How To Love Your Afro,
// Chapter 9: Trichology vs Dermatology, pp 126–130 (the comprehensive
// list of conditions a trichologist or dermatologist diagnoses) and
// Chapter 12: Scalp Health First, pp 151–153 (Paige's elaboration of
...
export const DIAGNOSED_CONDITIONS: Topic = {
  ...
  body: `These are conditions a trichologist or dermatologist diagnoses — not the AI, not the user, and never STRAND. The only role here is to recognise the names accurately when they appear in a user's profile and frame what the book has to say about them.

Hair-loss conditions covered in the book:
...
Scalp conditions covered in the book:
