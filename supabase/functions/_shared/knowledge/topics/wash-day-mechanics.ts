...
Saturation comes first, and it is not a timed step: before any shampoo touches the hair, the whole head must be soaked through — roots, nape, crown and the dense middle included. Work the water in by sections, lifting and separating so it reaches the scalp, and keep going until every curl is heavy, dripping and clumped together rather than springy and dry-looking. How long that takes depends on the hair, not the clock: short or fine or high-porosity hair may be soaked in a minute or two, while long, dense, coarse or tightly-coiled hair — and especially low-porosity hair, whose closed cuticle actively repels water at first — can need several minutes of patient work. Do not rush it; it takes as long as it takes. Why it matters: water is the only true moisturiser, and water is also what lets shampoo lather and spread thinly instead of being scrubbed into one spot. Any dry patch is a patch that never gets properly cleansed, never gets conditioned, and stays dehydrated for the rest of the week — dry patches at the back, the nape, the crown and the dense middle are the most common wash-day failure.
