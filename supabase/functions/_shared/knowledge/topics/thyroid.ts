...
// SAFETY NOTE: the STRAND manuscript does NOT cover thyroid clinically.
// The book covers blood work as part of what dermatologists do and curl specialists as a "first line of defence" against
// vitamin deficiencies and hormonal imbalances. This
...
export const THYROID: Topic = {
 ...
 body: `STRAND's framing on thyroid markers (TSH, T3, T4) is intentionally narrow because the STRAND manuscript does not cover thyroid clinically. What the manuscript does say is the bigger principle: the hair and scalp can communicate everything from hormonal imbalances and vitamin deficiencies to recent sugar binges, all of which could be affecting much more than just the hair. Curl specialists, trichologists and dermatologists can be a first line of defence against the identification of serious medical conditions before the user even knows they exist.

Dermatologists, unlike trichologists, are medical doctors. They can complete blood work for their patients, which can be hugely valuable for diagnosing underlying medical conditions or deficiencies that might be contributing to hair loss. When a thyroid panel is in the user's profile, that means a clinician already drew the blood — the work has been done by someone qualified to interpret it.
...
— Improvise specific mechanisms ("low T3 causes X type of hair loss") that the manuscript does not explicitly support.
