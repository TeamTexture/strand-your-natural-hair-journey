...
— Behaviour pattern. If hair takes longer than usual to wet down, stops reacting to styling products in the way it normally does, or curls feel heavy, tacky or even greasy to the touch, that's the same kind of build-up signal the manuscript describes — clarifying-shampoo territory.
...
A reasonable cadence the manuscript and the experts quoted in it suggest: not weekly. Every 4–5 washes is the rough rhythm Tootilab's Gaia Tonanzi names, "or when your hair feels heavy, greasy, or like your usual products are no longer working".

Daily-life pointers from the manuscript:

— A home water filter further purifies your drinking water. Some people also install a shower filter for hair-rinse water; the manuscript doesn't make a specific shower-filter recommendation but discusses the broader water-quality framing.
