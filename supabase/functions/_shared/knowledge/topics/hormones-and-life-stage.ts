...
// SAFETY NOTE: the STRAND manuscript covers stress hormones explicitly
...
// book. This topic body is grounded in what the manuscript DOES cover and
...
export const HORMONES_AND_LIFE_STAGE: Topic = {
 ...
 body: `Hormonal life stage shows up in STRAND's clinical data — pregnancy, postpartum, perimenopause, menopause, hormonal contraception. the STRAND manuscript is not a clinical hormone manual, and it doesn't try to be. The book's framing on hormones is two specific points:

Stress hormones can disrupt the hair growth cycle. The book is explicit on this in — stress hormones can push more hair than normal into the telogen (resting / shedding) phase, which is the underlying mechanism of telogen effluvium. This is one of the few places where the manuscript directly connects a physiological state to a named hair-loss pattern.

Curl specialists are a first line of defence. From (p 136): "Many times curl specialists can also be our first line of defence against the identification of serious medical conditions before we even know they exist. Our hair and scalp can communicate everything from hormonal imbalances and vitamin deficiencies to recent sugar binges, all of which could be affecting much more than just the health of our hair." A specialist in textured hair often spots patterns before the user does.

Beyond those two points, the manuscript does not cover:
