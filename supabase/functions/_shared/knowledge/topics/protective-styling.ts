...
export const PROTECTIVE_STYLING: Topic = {
 ...
 body: `What does it actually mean to wear a protective style? The term is incorrectly used far too often in the Afro and curly-haired community, and the manuscript is direct on this: a style that protects your hair shouldn't cause any breakage, damage or tension to your hair and scalp whatsoever. The visual category — braids, locs, weaves — doesn't determine whether a style is protective. The execution does.
...
Common high-tension culprits the manuscript names directly:
...
Low-manipulation, low-tension alternatives the manuscript explicitly endorses:
