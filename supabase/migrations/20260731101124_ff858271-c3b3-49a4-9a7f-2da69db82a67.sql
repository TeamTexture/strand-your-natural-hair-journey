...
AS $function$
  SELECT
    ...
    AND (
      ...
      OR COALESCE((SELECT complimentary_access FROM public.profiles WHERE user_id = _pro), false)
      OR EXISTS (
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(pr.complimentary_access, false),
