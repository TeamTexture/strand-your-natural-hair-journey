...
BEGIN
  ...
  ELSE
    IF NEW.approval_status = 'approved' AND OLD.approval_status <> 'approved' THEN
      ...
      NEW.rejection_reason := NULL;
      -- Approval publishes. Previously a product could sit approved and
      -- invisible because is_published was a separate brand-side step.
...
WHERE approval_status = 'approved' AND is_published = false;