...
export function useHomeAlerts() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // 7b. Past-due upcoming appointments are surfaced as a mid-screen
      // pop-up (see <AppointmentFollowUpDialog />) rather than a list alert,
      // so we intentionally do not push anything into `next` here.
