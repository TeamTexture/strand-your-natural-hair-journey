...
/**
 * Member forgot-password entry. Posts to the shared password-reset edge
 * function with audience "member", which mints a single-use native recovery
 * link and delivers it via Resend from noreply@mystrand.co.uk. The success
 * state is identical whether or not the email is registered.
 */
      ...
      <div className="px-7 pt-2 pb-10">
        ...
        {sent ? (
          <div className="space-y-3">
            <Button variant="gold" size="pill" onClick={() => nav("/auth?mode=signin")}>
              Back to sign in →
            </Button>
            <button
              type="button"
