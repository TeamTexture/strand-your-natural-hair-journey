    ...
    <>
      <div className={cn("relative", className)}>
        <button
          ...
          className="h-8 pl-2 pr-2.5 inline-flex items-center gap-1.5 rounded-pill border border-border bg-card text-foreground/80 hover:border-primary/50 hover:text-primary transition-colors"
        >
          <LevelBars level={level} />
          <span className="text-[10px] font-body font-medium tracking-[0.04em]">
